<?php
      ...
      function accepted_community_waiting()
       {
           ...
           $messag = $displayMessages['accepted_temporaryOut'];
           ...
           $insert_accept_community = $pdo->prepare("INSERT INTO waiting_request(wait_surname,wait_firstname,wait_email,wait_website,wait_organisation,wait_telnr,wait_culturart,wait_district,wait_add_date) VALUES(?,?,?,?,?,?,?,?,NOW())");
           ...
           <div class="notificationIcons">
             ...
             <p class="communityNotification">De <?php echo strtoupper($select_community_result['accept_organisation']);?> VERENIGING is in de WACHTLIJST toegevoegd. Een mail<span class="icon-envelop"></span> is naar hun gestuurd  waarin informaties staan. Als u de inhoud van de mail wil veranderen voor de volgend keer klick rechtsboven op de mail. Daar kunt u de mails die worden naar de vereniging vestuur aanpassen en nog meer doen..</p>
