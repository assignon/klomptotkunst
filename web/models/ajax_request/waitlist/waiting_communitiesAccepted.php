<?php
     ...
     require "../pdo_connection.php";
      ...
      function waiting_community_accepted()
       {
           ...
           $messag  = $displayMessages['temporary_accept'];
           ...
           $insert_accept_community->execute(array($select_community_result['wait_surname'], $select_community_result['wait_firstname'], $select_community_result['wait_email'], $select_community_result['wait_website'], $select_community_result['wait_organisation'], $select_community_result['wait_telnr'], $select_community_result['wait_culturart'], $select_community_result['wait_district']));
